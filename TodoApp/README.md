...
To update the database use this command from the Web project folder (replace `TodoApp` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../TodoApp.Infrastructure/TodoApp.Infrastructure.csproj -s TodoApp.Web.csproj
```
